...
Layout: 2 metric rows × 9 columns (4 distributions + spacer + 4 distributions).
...
METRICS = [
    ("explained_variance", "R<sup>2</sup>"),
    ("shrinkage", "Shrinkage"),
]
...
# %%
# --- Layout: 2 rows × 9 cols (col 5 is a spacer) ---
...
# --- Save ---
_fd = fig_dir()
fig.write_image(f"{_fd}/reconstruction_metrics.pdf", engine="kaleido")
fig.write_image(f"{_fd}/reconstruction_metrics.svg", engine="kaleido")
